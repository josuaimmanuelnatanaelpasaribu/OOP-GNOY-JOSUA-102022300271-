...
public class TaskFileManager {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(FILE_PATH))) {
            ...
            while ((line = reader.readLine()) != null) {
                try {
                    ...
                    System.err.println("Kesalahan saat mengurai tugas: " + e.getMessage()); // Menampilkan error parsing tugas
                }
            }
        } catch (FileNotFoundException e) {
            System.err.println("File tugas tidak ditemukan. File tugas baru akan dibuat."); // File tidak ditemukan, file baru akan dibuat
        } catch (IOException e) {
            System.err.println("Kesalahan saat membaca file tugas: " + e.getMessage()); // Error saat membaca file
        }
    ...
    public static void saveTasks(ArrayList<Task> tasks) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(FILE_PATH))) {
            ...
            System.err.println("Terjadi kesalahan saat menulis ke file tugas: " + e.getMessage()); // Error saat menulis ke file
        }
    }
}
