...
public class MainAppController {
    ...
    private void addTask() {
        try {
            ...
            if (titleField.getText().isEmpty() || priorityBox.getValue() == null || dueDatePicker.getValue() == null) {
                ...
                throw new MissingFieldException("Semua kolom harus diisi.");
            }
    ...
    private void deleteTask() {
        try {
            ...
            if (selected == null) {
                ...
                throw new TaskNotSelectedException("Tidak ada tugas yang dipilih untuk dihapus.");
    ...
    private void markTaskComplete() {
        try {
            ...
            if (selected == null) {
                // TODO: Throw new TaskNotSelectedException dengan pesan yang sesuai 
                throw new TaskNotSelectedException("Tidak ada tugas yang dipilih untuk ditandai sebagai selesai.");
            }
